...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/expecttest-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13522&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/expecttest-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `expecttest` can be installed with:

```
conda install expecttest
```

It is possible to list all of the versions of `expecttest` available on your platform with:
